...
class FingerPrint extends React.Component {
    ...
    //  this.props.navigation.navigate('Root', { screen: 'ReportScreen' });;
    ...
    getPhaseColor(): string {
        return Fingerprint['PHASE_'+this.state.phase.toUpperCase()];
    }
...
export default withNavigation(FingerPrint);
